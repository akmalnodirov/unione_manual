...
<template>
  <div class="w-full pb-12 bg-gradient-to-b from-[rgba(209,209,202,0.3)] to-[rgba(39,40,41,0.5)]">
    <div class="w-[90%] max-w-7xl m-auto pt-4">
      <div class="w-full max-w-xs mx-auto mb-8">
        <h1 class="text-3xl max-md:text-2xl font-medium mb-4 text-center text-custom-color"
      ...
      <div class="flex flex-col lg:flex-row justify-center gap-6 pb-4">
        ...
        <div class="w-full lg:w-[40%]">
          <h2 class="text-center text-2xl font-bold mb-6 lg:mb-4">Contact us</h2>
          <form @submit.prevent="sendEmail" class="space-y-4 md:space-y-6">
    <div>
      <label for="firstname" class="block text-sm md:text-lg my-2">First Name</label>
      <input
        type="text"
        v-model="form.firstname"
        placeholder="Name"
        class="p-3 md:p-4 w-full rounded border border-gray-400"
        style="background-color: rgb(209, 209, 202);"
        required
      />
    </div>
    <div>
      <label for="email" class="block text-sm md:text-lg my-2">Email</label>
      <input
        type="email"
        v-model="form.email"
    ...
    <div>
      <label for="number" class="block text-sm md:text-lg my-2">Phone Number</label>
      <input
        type="number"
        v-model="form.number"
    ...
    <div>
      <label for="message" class="block text-sm md:text-lg my-2">Message</label>
      <textarea
        id="message"
    ...
    <button
      type="submit"
      class="text-white bg-red-800 font-medium font-georgia px-8 py-3 md:px-12 md:py-4 w-full lg:w-[150px] text-lg md:text-xl"
    >
      Submit
    </button>
  </form>
        ...
        <div class="w-full lg:w-[50%] flex flex-col justify-between">
          <h2 class="text-center text-2xl font-bold mb-6 lg:mb-4">Head Office</h2>
          <div class="space-y-5 px-12 max-sm:px-1">
           ...
           <div class="flex flex-col gap-2">
            <p class="flex items-center gap-2 text-xl md:text-base color-custom">
              <img
                ...
                <a href="#" class="text-2xl md:text-xl">route.support.eld@gmail.com</a>

              </p>
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
                src="https://optim.tildacdn.net/tild3034-3932-4432-b432-646461656633/-/cover/36x36/center/center/-/format/webp/email.png"
                alt="email" class="w-6 h-6" />
                <a href="#" class="text-2xl md:text-xl">routeld.sales.eld@gmail.com</a>
            ...
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
                ...
                <a href="#" class="text-2xl md:text-xl">support@routeld.com</a>
          ...
          <div class="flex flex-col gap-2">
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
                ...
                alt="phone" class="w-6 h-6" />
              <a href="#" class="text-2xl md:text-xl">support: +1(321) 999-7776 ext.101</a>
            </p>
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
                src="https://optim.tildacdn.net/tild6132-6636-4461-a163-323864663161/-/cover/36x36/center/center/-/format/webp/phone_icon.png"
                alt="phone" class="w-6 h-6" />
              <a href="#" class="text-2xl md:text-xl">sales: +1(707) 957-0000</a>
            </p>
          </div>
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
           ...
           <div class="flex flex-col gap-2">
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
                ...
                alt="telegram" class="w-6 h-6" />
              <a href="#" class="text-2xl md:text-xl">route.eld</a>
            </p>
            <p class="flex items-center gap-2 text-lg md:text-base color-custom">
              <img
